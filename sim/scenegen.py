...
class SceneGen :
    ...
    def update(self, pitch=None, yaw=None, roll=None, pose=None, progress_data=None, target_position=None) :
        ...
        if self.state == "home":
            ...
            if pitch is None or yaw is None or roll is None or pose is None:
                return True
            return self.update_calibration(pitch, yaw, roll, pose, progress_data, target_position)
    ...
    def update_calibration(self, pitch, yaw, roll, pose, progress_data=None, target_position="center"):
        minYaw = -70
        maxYaw = 70
        minPitch = -20
        maxPitch = 20
